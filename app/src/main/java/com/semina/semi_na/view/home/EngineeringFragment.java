...
import com.semina.semi_na.databinding.FragmentEngineeringBinding;
...
public class EngineeringFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.engineeringRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        binding.engineeringRecyclerView.setAdapter(adapter);
    }
