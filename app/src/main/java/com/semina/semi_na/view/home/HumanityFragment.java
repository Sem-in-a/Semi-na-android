...
import com.semina.semi_na.databinding.FragmentHumanityBinding;
...
public class HumanityFragment extends Fragment {
    private FragmentHumanityBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHumanityBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query baseQuery = FirebaseFirestore.getInstance()
                ...
                .whereEqualTo("majorCategory", "HUMANITY");
        ...
        binding.humanityRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        binding.humanityRecyclerView.setAdapter(adapter);
    }
