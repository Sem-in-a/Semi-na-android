...
import com.semina.semi_na.databinding.FragmentLawBinding;
...
public class LawFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query baseQuery = FirebaseFirestore.getInstance()
                ...
                .whereEqualTo("majorCategory", "LAW");
        ...
        binding.lawRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        binding.lawRecyclerView.setAdapter(adapter);
    }
