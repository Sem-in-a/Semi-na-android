...
import com.semina.semi_na.databinding.FragmentNaturalScienceBinding;
...
public class NaturalScienceFragment extends Fragment {
    private FragmentNaturalScienceBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNaturalScienceBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query baseQuery = FirebaseFirestore.getInstance()
                ...
                .whereEqualTo("majorCategory", "SCIENCE");
        ...
        binding.naturalScienceRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        binding.naturalScienceRecyclerView.setAdapter(adapter);
    }
