...
import com.semina.semi_na.databinding.FragmentEconomicsBinding;
...
public class EconomicsFragment extends Fragment {
    private FragmentEconomicsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEconomicsBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query baseQuery = FirebaseFirestore.getInstance()
                ...
                .whereEqualTo("majorCategory", "ECONOMIC");
        ...
        binding.economicsRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        binding.economicsRecyclerView.setAdapter(adapter);
    }
