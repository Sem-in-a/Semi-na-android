...
import com.semina.semi_na.databinding.FragmentBusinessBinding;
...
public class BusinessFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query baseQuery = FirebaseFirestore.getInstance()
                ...
                .whereEqualTo("majorCategory", "BUSINESS");
        ...
        binding.businessRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
